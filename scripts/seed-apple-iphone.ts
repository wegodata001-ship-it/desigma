...
import { seedAppleIphoneCatalog } from "../src/lib/presets/appleIphonePreset";
...
async function main() {
  await seedAppleIphoneCatalog(prisma, STORE_ID);
  console.log(`Apple iPhone catalog (Stage 1) seeded for store: ${STORE_ID}`);
}
