...
import { seedAppleWatchCatalog } from "../src/lib/presets/appleWatchPreset";
...
async function main() {
  await seedAppleWatchCatalog(prisma, STORE_ID);
  console.log(`Apple Watch catalog (Stage 3) seeded for store: ${STORE_ID}`);
}
