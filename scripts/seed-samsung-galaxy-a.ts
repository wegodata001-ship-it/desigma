...
import { seedSamsungGalaxyACatalog } from "../src/lib/presets/samsungGalaxyAPreset";
...
async function main() {
  await seedSamsungGalaxyACatalog(prisma, STORE_ID);
  console.log(`Samsung Galaxy A catalog (Part 3) seeded for store: ${STORE_ID}`);
}
