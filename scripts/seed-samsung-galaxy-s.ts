...
import { seedSamsungGalaxySCatalog } from "../src/lib/presets/samsungGalaxySPreset";
...
async function main() {
  await seedSamsungGalaxySCatalog(prisma, STORE_ID);
  console.log(`Samsung Galaxy S catalog (Part 1) seeded for store: ${STORE_ID}`);
}
